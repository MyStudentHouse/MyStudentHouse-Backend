...
class TaskController extends Controller
{
    ...
    /**
      ...
      * @retval 200 JSON Instance of Task
    ...
    /**
     * @par API\TaskController@show (GET)
     * Request information of a task, before it can be edited, necessary for front-end
     * 
    ...
    /**
     * @par API\TaskController@showUser (GET)
     * Gets all the tasks belonging to the user
     *
     * @param house_id  Which user to index the tasks for
     * @retval 200 JSON Task per use, each of the instance of Task
     * @retval 412 JSON Error
     */
    ...
    /**
     * @par API\TaskController@showTaskPerWeek (GET)
     ...
     * @retval 200 JSON Task per week, each of the instance of Task
     * @retval 412 JSON Error
     */
    public function showTaskPerWeek($task_id, $no_weeks)
    {
    ...
    /**
     * @par API\TaskController@showHousePerWeek (GET)
     ...
     * @retval 412 JSON Error
     */
    public function showHousePerWeek($house_id, $no_weeks)
    {
        $houseController = new HouseController();
        if(!$houseController->userBelongsToHouse($house_id, Auth::id())) {
            return response()->json(['error' => 'User does not belong to this house'], $this->errorStatus);
    ...
    /**
     * @par API\TaskController@showUserPerWeek (GET)
     * Retrieve the tasks for a certain user for a certain number of upcoming weeks
     *
     * @param house_id     The ID of the user to retrieve the tasks for
     * @param no_weeks     The number of weeks to return tasks for
     ...
     * @retval 412 JSON Error
     */
    public function showUserPerWeek($user_id, $no_weeks)
    {
     ...
     * @param reminder         Boolean which indicates a reminder needs to be sent (0 for false, 1 for true)
     * @param mark_complete    Boolean which indicates if the task need to be marked as complete (0 for false, 1 for true)
     * @retval 200 JSON Update instance of Task
     * @retval 412 JSON Error
     */
     ...
     * @retval 200 JSON Deleted instance of Task
     * @retval 412 JSON Error
     */
